      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-10 py-16 space-y-20">
        ...
        <section className="text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link href="/book/autorex-suite-demo" className="rounded-xl bg-red-500 hover:bg-red-600 px-6 py-3 text-sm font-semibold text-white transition-colors inline-flex items-center gap-2">
        ...
        <section className="rounded-2xl border border-red-500/20 bg-red-500/5 p-10 md:p-12 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link href="/book/autorex-suite-demo" className="inline-flex items-center gap-2 rounded-xl bg-red-500 hover:bg-red-600 px-6 py-3 text-sm font-semibold text-white transition-colors">
              Book a demo <ArrowRight className="h-4 w-4" />
            </Link>
