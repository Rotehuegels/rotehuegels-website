...
const STATES = [
  { name: 'Uttar Pradesh',     recyclers: 121, capacity: 624219,  color: 'text-emerald-400' },
  { name: 'Maharashtra',       recyclers: 140, capacity: 118032,  color: 'text-emerald-400' },
  { name: 'Karnataka',         recyclers: 72,  capacity: 126015,  color: 'text-emerald-400' },
  { name: 'Haryana',           recyclers: 43,  capacity: 157188,  color: 'text-emerald-400' },
  { name: 'Tamil Nadu',        recyclers: 42,  capacity: 130636,  color: 'text-amber-400' },
  { name: 'Gujarat',           recyclers: 41,  capacity: 158605,  color: 'text-emerald-400' },
  { name: 'Rajasthan',         recyclers: 27,  capacity: 82008,   color: 'text-emerald-400' },
  { name: 'Telangana',         recyclers: 23,  capacity: 148115,  color: 'text-emerald-400' },
  ...
  { name: 'Jammu & Kashmir',   recyclers: 3,   capacity: 705,     color: 'text-zinc-400' },
  { name: 'Chhattisgarh',      recyclers: 2,   capacity: 6750,    color: 'text-zinc-400' },
  { name: 'Goa',               recyclers: 2,   capacity: 153,     color: 'text-zinc-400' },
  { name: 'Himachal Pradesh',  recyclers: 2,   capacity: 1500,    color: 'text-zinc-400' },
  { name: 'Jharkhand',         recyclers: 2,   capacity: 660,     color: 'text-zinc-400' },
  { name: 'Assam',             recyclers: 1,   capacity: 120,     color: 'text-zinc-400' },
  { name: 'Kerala',            recyclers: 1,   capacity: 1200,    color: 'text-zinc-400' },
];
...
const TOTAL_RECYCLERS = 569;
const TOTAL_CAPACITY = 1790348;
    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl font-bold">CPCB Registered E-Waste Recyclers in India</h1>
        </div>
        <p className="text-sm text-zinc-500 mb-8">
          Directory of {fmtNum(TOTAL_RECYCLERS)} authorized dismantlers and recyclers across {STATES.length} states,
          as per authorisation issued by SPCBs/PCCs under E-Waste (Management) Rules, 2022.
        </p>
                ...
                {filteredStates.map((s, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className={`px-4 py-3 text-right font-bold ${s.color}`}>{s.recyclers}</td>
