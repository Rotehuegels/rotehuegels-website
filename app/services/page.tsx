...
export default function ServicesPage() {
  return (
    <section className="container space-y-12 md:space-y-16">
      {/* Hero */}
      <header className="pt-10 md:pt-12">
      ...
      {/* CTA */}
      <div className="rounded-2xl border border-zinc-800 bg-gradient-to-br from-zinc-900/40 to-zinc-900/20 p-6 md:p-8">
