...
import {
  ...
  Receipt, Briefcase, ArrowRight, CheckCircle2, Database,
} from 'lucide-react';
        ...
        <div className="relative max-w-[1800px] mx-auto text-center">
          ...
          <div className="flex justify-center">
            <div className="inline-flex items-center gap-2 rounded-full bg-rose-500/10 border border-rose-500/20 px-4 py-1.5 mb-6">
              ...
              <span className="text-xs font-medium text-rose-400">AutoREX Suite · Business Layer</span>
            </div>
          </div>
          <h1 className="text-4xl md:text-6xl font-black leading-tight">
            Operon —<br />
            <span className="text-rose-400">the ERP that actually knows your plant.</span>
          </h1>
      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-10 pb-16 space-y-20">
        ...
        <section className="rounded-2xl border border-sky-500/20 bg-sky-500/5 p-10 md:p-12 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link href="/book/autorex-suite-demo" className="inline-flex items-center gap-2 rounded-xl bg-sky-500 hover:bg-sky-600 px-6 py-3 text-sm font-semibold text-white transition-colors">
