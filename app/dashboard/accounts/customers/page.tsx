      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-6">
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="flex items-center gap-2 rounded-xl border border-zinc-700 bg-zinc-800/60 px-3 sm:px-4 py-2 sm:py-2.5 text-sm font-semibold text-zinc-300 hover:border-zinc-600 transition-colors"
          >
          ...
          <table className="w-full text-sm min-w-[640px]">
            <thead>
              <tr className="border-b border-zinc-800 bg-zinc-900/60">
                <th className="px-3 md:px-5 py-2.5 md:py-3 text-left text-xs font-semibold text-zinc-400 uppercase tracking-wide">ID</th>
                <th className="px-3 md:px-5 py-2.5 md:py-3 text-left text-xs font-semibold text-zinc-400 uppercase tracking-wide">Name</th>
                <th className="px-3 md:px-5 py-2.5 md:py-3 text-left text-xs font-semibold text-zinc-400 uppercase tracking-wide">GSTIN</th>
                <th className="px-3 md:px-5 py-2.5 md:py-3 text-left text-xs font-semibold text-zinc-400 uppercase tracking-wide">Contact</th>
                <th className="px-3 md:px-5 py-2.5 md:py-3 text-left text-xs font-semibold text-zinc-400 uppercase tracking-wide">State</th>
                <th className="px-3 md:px-5 py-2.5 md:py-3 text-left text-xs font-semibold text-zinc-400 uppercase tracking-wide"></th>
              </tr>
            </thead>
